 ...
 * because the Builder has three places and a nested rail would cost width the
 * library table wants.
 */
const TABS = [
...
export function BuilderNav({ current }: { current: string }) {
  return (
    <nav aria-label="Builder" className="mb-4 flex gap-4 border-line [border-bottom-width:1px]">
      {TABS.map((tab) => {
